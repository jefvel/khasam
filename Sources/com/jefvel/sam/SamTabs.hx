...
{
	//tab40672
	public static var stressInputTable = [
		'*', '1', '2', '3', '4', '5', '6', '7', '8'
	];

	//tab40682
	public static var signInputTable1 = [
		' ', '.', '?', ',', '-', 'I', 'I', 'E',
		'A', 'A', 'A', 'A', 'U', 'A', 'I', 'E',
		'U', 'O', 'R', 'L', 'W', 'Y', 'W', 'R',
		'L', 'W', 'Y', 'M', 'N', 'N', 'D', 'Q',
	...
	//tab40763
	public static var signInputTable2 = [
		'*', '*', '*', '*', '*', 'Y', 'H', 'H',
		'E', 'A', 'H', 'O', 'H', 'X', 'X', 'R',
		'X', 'H', 'X', 'X', 'X', 'X', 'H', '*',
		'*', '*', '*', '*', '*', 'X', 'X', '*',
	...
	//tab45616???
	public static var phonemeStressedLengthTable = [
	...
	//tab45536???
	public static var phonemeLengthTable = [
